<template>
  <section class="h-auto bg-white dark:bg-black">
    <div class="flex flex-col mt-16 px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      >
        ...
        <span
          class="text-xl font-extrabold sm:text-2xl md:text-3xl lg:text-4xl mt-2"
          >Welcome back!</span
        >
      </a>
      ...
      <!-- Form Section -->
      <div
        class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-black-800 dark:border-gray-700"
      >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4 md:space-y-6">
            <div>
              ...
              <input
                ...
                name="email"
                id="email"
                class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-black-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input
                    ...
                    type="checkbox"
                    class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-black-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800"
                  />
                </div>
