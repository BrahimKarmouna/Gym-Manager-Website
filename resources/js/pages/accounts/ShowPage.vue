<template>
  <div>
    <section class="h-screen bg-white py-8 antialiased dark:bg-black md:py-8">
      <div class="mx-auto max-w-screen-2xl px-4 3xl:px-0">
        ...
        <div class="py-4 md:py-8">
          <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
            <div class="flex space-y-4 space-x-4">
              <img
                class="h-20 w-20 rounded-full bg-gray-200"
            ...
            <div class="space-y-4">
              <dl v-if="account.rib">
                ...
                <dd class="text-gray-500 dark:text-gray-400 text-bold">
                  {{ account.rib }}
                </dd>
              </dl>
        ...
        <div
          class="grid w-full grid-cols-1 gap-4 mt-4 sm:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 mb-5"
        >
          <div
            class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-black-800"
          >
            <div class="w-full">
              <q-icon
              ...
              />
              <h3
                class="text-base font-normal text-gray-800 dark:text-gray-400"
              >
                Account Balance
              </h3>
              <span
                class="pt-4 m-4 mt-3text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white"
              >
                {{ account.balance }} MAD
              </span>
            </div>
          ...
          >
            <div class="w-full">
              <q-icon name="trending_up" class="text-emerald-600" size="md" />
              <h3
          ...
          >
            <div class="w-full">
              <q-icon name="trending_down" class="text-red-600" size="md" />
              <h3
                class="text-base font-normal text-gray-500 dark:text-gray-400"
              >
                Account Expenses
