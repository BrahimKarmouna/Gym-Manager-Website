...
<template v-slot:body-cell-actions="props">
  ...
  <div
    class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-black-800 md:p-8 w-3/3"
  >
    <div>
      <h3 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white mt-5">
        Account Incomes
      </h3>
      <div
        v-if="data.length > 0"
