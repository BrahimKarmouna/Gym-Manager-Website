      ...
      <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div class="flex items-center p-8 bg-white shadow rounded-lg dark:bg-gray-800">
          ...
          <div>
            ...
            <span class="block text-gray-500 dark:text-gray-400">Total</span>
          </div>
        </div>
      </section>
      <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6 ">
        <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg dark:bg-gray-800">
        ...
        <div class="row-span-3 bg-white shadow rounded-lg dark:bg-gray-800">


        </div>
        <div class="flex flex-col row-span-3 bg-white shadow rounded-lg dark:bg-gray-800">
