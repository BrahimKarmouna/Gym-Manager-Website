<template>
  ...
  <div class="mx-auto px-4">
      ...
      <div class="grid w-full grid-cols-1 gap-4 mt-4 sm:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 mb-5">
        <div
          ...
          <div class="w-full">
            ...
            <span
              class=" pt-4 m-4 mt-3text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">3</span>
    ...
    <div class="bg-gray-100 py-7 rounded-xl dark:bg-gray-800 my-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 items-stretch gap-4 mb-10">
      ...
      <section v-for="account in accounts" :key="account.id"
        ...
        <header class="flex text-white z-20 mb-4">
          <q-icon name="sym_r_account_balance" size="md" />

          <q-btn icon="sym_r_more_vert" unelevated padding="sm" size="sm" class="ms-auto">
            <q-menu class="p-2 min-w-36" anchor="bottom right" self="top right" :offset="[0, 10]">

              <q-list dense>
                <q-item class="rounded-lg" clickable v-close-popup @click="editeItem(account)">
                ...
                <q-item clickable class="text-negative rounded-lg" v-close-popup @click="deleteItem(account)">
                  <q-item-section class="flex-auto">
        ...
        <div class="text-gray-100 z-30 mb-4">
          ...
          <div class="tracking-widest text-xl">{{ account.name }}</div>

          <div class="font-thin">RIB</div>
          <div class="tracking-widest text-xl">{{ account.rib }}</div>
        </div>

        <!-- Footer -->
        <div class="flex items-center justify-between text-white flex-nowrap">
          <span class="text-xl truncate">Balance: $ {{ account.balance }}</span>

          <q-btn unelevated class="bg-green-500 whitespace-nowrap text-white rounded-lg">Check it Now</q-btn>
