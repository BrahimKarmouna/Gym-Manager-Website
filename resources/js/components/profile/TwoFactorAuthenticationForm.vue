        ...
        <q-card-section class="q-pb-none">
          ...
          <div v-if="twoFactorEnabled">
            <div v-if="qrCode">
              ...
              <div v-if="confirming"
                   class="mt-4">
                <q-input v-model="confirmationForm.code"
                         outlined
                         dense
                         hide-bottom-space
                         label="Code"
        ...
        <q-card-section>
          ...
          <template v-else>
            ...
            <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
              <template #default="{ startConfirmingPassword }">
                <q-btn v-if="recoveryCodes.length > 0 && !confirming"
                       @click="startConfirmingPassword"
                       class="me-3"
                       unelevated
                       outline
...
function confirmTwoFactorAuthentication() {
  ...
  api.post('user/confirmed-two-factor-authentication', confirmationForm.value)
    .then(() => {
...
function regenerateRecoveryCodes() {
  api.post('/user/two-factor-recovery-codes')
